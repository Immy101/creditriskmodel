#1-Good aka Lower risk
#0-Bad aka Higher risk
import polars as pl
...
st.write("Enter information regarding the applicant to see whether their respective credit risk is good or bad.")
